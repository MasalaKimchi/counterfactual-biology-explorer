...
MANIFEST_PATHS = [
    ...
    "tests/test_certificate_dossier.py",
    "tests/test_combicone_cli.py",
    "tests/test_neural_baseline.py",
    "tests/test_screen_ingest.py",
    "tests/test_screenloop.py",
    ...
    "docs/metrics/benchmark_rankers_with_learned.csv",
    "docs/metrics/carpool_metrics.json",
    "docs/metrics/cross_screen_emergence.csv",
    "docs/metrics/emergence_certificate.csv",
    "docs/metrics/kway_real_summary.json",
    "docs/metrics/learned_ranker_confound_summary.csv",
    "docs/metrics/manuscript_numbers.json",
    "docs/metrics/norman_metrics.json",
    "docs/metrics/per_method_heldout_accuracy.csv",
    "docs/metrics/screenloop_carpool_metrics.json",
    "docs/metrics/screenloop_norman_metrics.json",
    "docs/metrics/synth_triple_results.json",
    "docs/metrics/synth_triple_screen_config.json",
    "docs/figures/fig_analytic_null_fragility.png",
    "docs/figures/fig_analytic_null_fragility.pdf",
    "tutorial/README.md",
    "tutorial/tutorial.ipynb",
    "results/findings.json",
    "results/analytic_vs_mc_validation.json",
    "results/analytic_vs_mc_by_double.csv",
