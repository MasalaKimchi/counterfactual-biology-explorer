...
literature, formulated the convex-cone emergence-certificate framework, wrote the analysis code
(\texttt{reachability.py}, \texttt{combicone.py}, \texttt{neural\_baseline.py}, and the
accompanying notebooks), executed the computations on the measured combinatorial perturbation
screens, produced the figures and tables, and drafted and revised this manuscript. We disclose this openly and in detail because the AI's role was central rather
...
included setting the scientific goal (a falsifiable, screen-relative test of combinatorial
emergence), selecting the primary dataset (the combinatorial CRISPRa Perturb-seq screen of
\citet{Norman2019}) and the orthogonal cross-screen transfer target
(\citet{Wessels2023}), steering the framing and scope, and reviewing, questioning, and validating the model's
